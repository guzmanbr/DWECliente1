...
document.getElementById('modificarId').addEventListener('change', function (params) {
    params.preventDefault();
    let cont = 0;
            ...
            .then((datos) => {
                ...
                datos.forEach(eleme => {
                    if (eleme.id == idProducto) {
                        ...
                        document.getElementById('idNombre').value = eleme.name;
                        document.getElementById('idDesc').value = eleme.descrip;
                        cont++;
                    } else if (cont == 0) {
...
$('#modificar').submit(function (params) {
    ...
    if (idProducto == "") {
        ...
        const producto = {
            ...
            descrip: document.getElementById('idDesc').value
        }
        //Introducimos el preoducto creado en el fichero json
        fetch(`${SERVER}/productos`, {
            method: 'POST',
