...
async function repartirNaipe(nomJugador, numCartas) {
    ...
    for (let i = 0; i < numCartas; i++) {
        let cartasSuf = false;// Esta línea define una variable booleana llamada cartasSuf que se utiliza para indicar si se han repartido todas las cartas.
        let carta = 0;
        while (!cartasSuf) {//Este es un bucle while que se utiliza para repetir el proceso de repartir una carta hasta que se hayan repartido todas las cartas.
            ...
            if (naipes[0].lugar === "mazo") {
                ...
                //esta línea cambia el valor de la variable cartasSuf a true, lo que indica que se ha repartido una carta y se puede continuar con la siguiente iteración de
                // el bucle o terminar el bucle while si ya se han repartido todas las cartas.
                cartasSuf = true;
            }
        }
    }
